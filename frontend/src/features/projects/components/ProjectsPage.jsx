...
export default function ProjectsPage() {
  ...
  return (
    <section>
      ...
      {role === 'admin' && (
        <form
          className="mt-4 grid gap-2 rounded-lg border border-slate-200 bg-white p-4 sm:grid-cols-2"
        ...
        >
          ...
          />
          <button className="rounded-md bg-indigo-600 px-3 py-2 text-white sm:col-span-2">
            Create project
          </button>
        </form>
      )}
